...
The SDK accepts a dictionaries of values, indexed by a pre-\/defined set of keys (below), and uses these to set the properties of the library's user interface.
