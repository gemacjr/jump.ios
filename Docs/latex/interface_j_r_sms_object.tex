...
Returns a {\ttfamily \hyperlink{interface_j_r_sms_object}{JRSmsObject}} initialized with the given message and URLs that you wish to be shortened to the \href{http://rpxnow.com/docs/iphone#shorten_urls}{\tt http://rpx.me/} format.
