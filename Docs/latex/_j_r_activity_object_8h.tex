...
class \hyperlink{interface_j_r_email_object}{JREmailObject}
\begin{DoxyCompactList}\small\item\em Object containing content to be shared by email. \item\end{DoxyCompactList}\item 
class \hyperlink{interface_j_r_sms_object}{JRSmsObject}
\begin{DoxyCompactList}\small\item\em Object containing the default message to be shared by sms. \item\end{DoxyCompactList}\item 
...
Interface for creating and populating activities that you wish to publish to your user's social networks. Create an activity object, fill in the object's fields, and pass the object to the \hyperlink{interface_j_r_engage}{JREngage} library when you are ready to share. 