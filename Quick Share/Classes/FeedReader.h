...
@interface Story : NSObject
{
    ...
    NSString *enclosure;	/* Describes a media object that is attached to the item. */
...
@property (readonly) NSString *enclosure;
...
{
	// The name of the channel. It's how people refer to your service. If you have an HTML website that contains the same information as your RSS file, the title of your channel should be the same as the title of your website. 	GoUpstate.com News Headlines
    NSString *title;
    
	// The URL to the HTML website corresponding to the channel.	http://www.goupstate.com/
    NSString *link;
    
    // Phrase or sentence describing the channel.	The latest news from GoUpstate.com, a Spartanburg Herald-Journal Web site.
    NSString *description;

    NSString *language;         /* The language the channel is written in. This allows aggregators to group all Italian language sites, for example, on a single page. A list of allowable values for this element, as provided by Netscape, is here. You may also use values defined by the W3C.en-us */
    ...
    NSString *category;         /* Specify one or more categories that the channel belongs to. Follows the same rules as the <item>-level category element. (e.g., "<category>Newspapers</category>") */
