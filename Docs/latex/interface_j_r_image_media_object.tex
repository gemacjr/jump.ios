...
\index{JRImageMediaObject@{JRImageMediaObject}!imageMediaObjectWithSrc:andHref:@{imageMediaObjectWithSrc:andHref:}}
\index{imageMediaObjectWithSrc:andHref:@{imageMediaObjectWithSrc:andHref:}!JRImageMediaObject@{JRImageMediaObject}}
\subsubsection[{imageMediaObjectWithSrc:andHref:}]{\setlength{\rightskip}{0pt plus 5cm}+ (id) imageMediaObjectWithSrc: 
\begin{DoxyParamCaption}
\item[{dummy(NSString $\ast$)}]{ \_\-src}
\item[{andHref:(NSString $\ast$)}]{ \_\-href}
\end{DoxyParamCaption}
