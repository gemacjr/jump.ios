...
If your email message body contains URLs that you would like shortened to an \href{http://rpxnow.com/docs/iphone#shorten_urls}{\tt http://rpx.me/} URL (with which you can track click-\/throughs), add the exact URL(s) to the {\ttfamily urls} array. The library will contact the Engage servers to obtain shortened URLs and replace any instance of the url in your email body.
