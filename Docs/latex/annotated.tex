...
\item\contentsline{section}{\hyperlink{interface_j_r_email_object}{JREmailObject} (Object containing content to be shared by email )}{\pageref{interface_j_r_email_object}}{}
\item\contentsline{section}{\hyperlink{class_j_r_engage}{JREngage} (Main API for interacting with the Janrain Engage for iPhone library )}{\pageref{class_j_r_engage}}{}
...
\item\contentsline{section}{\hyperlink{interface_j_r_sms_object}{JRSmsObject} (Object containing the default message to be shared by sms )}{\pageref{interface_j_r_sms_object}}{}
\end{DoxyCompactList}
