...
\begin{DoxyNote}{Note}
You can only include one \hyperlink{interface_j_r_flash_media_object}{JRFlashMediaObject} in the media array. Any others will be ignored.
\end{DoxyNote}
...
Returns a \hyperlink{interface_j_r_flash_media_object}{JRFlashMediaObject} initialized with the given swfsrc and imgsrc.
...
\index{JRFlashMediaObject@{JRFlashMediaObject}!flashMediaObjectWithSwfsrc:andImgsrc:@{flashMediaObjectWithSwfsrc:andImgsrc:}}
\index{flashMediaObjectWithSwfsrc:andImgsrc:@{flashMediaObjectWithSwfsrc:andImgsrc:}!JRFlashMediaObject@{JRFlashMediaObject}}
\subsubsection[{flashMediaObjectWithSwfsrc:andImgsrc:}]{\setlength{\rightskip}{0pt plus 5cm}+ (id) flashMediaObjectWithSwfsrc: 
\begin{DoxyParamCaption}
\item[{dummy(NSString $\ast$)}]{ \_\-swfsrc}
\item[{andImgsrc:(NSString $\ast$)}]{ \_\-imgsrc}
\end{DoxyParamCaption}
